...
import com.example.provider.SingleProviderApplication;
 ...
 */
@SpringBootTest(classes = SingleProviderApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
